...
namespace Fsuuaas\Promocodes\Traits;

use Carbon\Carbon;
use Fsuuaas\Promocodes\Models\Promocode;
use Fsuuaas\Promocodes\Facades\Promocodes;
use Fsuuaas\Promocodes\Exceptions\AlreadyUsedException;
use Fsuuaas\Promocodes\Exceptions\InvalidPromocodeException;
...
trait Rewardable
{
     ...
     *
     * @return null|\Fsuuaas\Promocodes\Model\Promocode
